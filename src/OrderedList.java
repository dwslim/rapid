...
public class OrderedList {
	...
	public static void main(String[] args) {
		...
		System.out.println("Num acquire skipped due to u clock: "
				+ (engine.state.acquires - engine.state.uAcquireSkipped - engine.state.sameThreadAcquireSkipped));

		System.out.println("processed acquires " + engine.state.sameThreadAcquireSkipped);

		System.out.println("total work would have done: "
				+ (((long) (engine.state.acquires + engine.state.releases + engine.state.joins + engine.state.forks
						- engine.state.sameThreadAcquireSkipped) * engine.state.numThreads) + engine.state.releases));
		System.out.println("Num deep copies: " + engine.state.deepcopies);
		System.out.println("total work done: " + (engine.state.cTraversed + engine.state.uTraversed
				+ ((long) (engine.state.deepcopies) * engine.state.numThreads)));
